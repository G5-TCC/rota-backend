...
export class PasswordController {
  ...
  @ApiOperation({ 
    ...
    description: 'Altera a senha do usuário utilizando o token de recuperação válido.'
  })
  ...
  async reset(@Body() resetData: ResetPasswordDto) {
    return this.securityFacade.resetPassword(resetData.token, resetData.password);
  }
}
